...
*/
        ...
        stage.getBatch().draw(nurse1, nurse1.getX(), nurse1.getY(),nurse1.getOriginX(),
                nurse1.getOriginY(),
                nurse1.getWidth(),nurse1.getHeight(),nurse1.getScaleX(),nurse1.
                        getScaleY(),nurse1.getRotation());
        stage.getBatch().end();
